...
if($_POST['passwd_0'])
{
	...
	if($passwd != $result)
	{
		echo ("<script type='text/javascript'>alert('密码错误！');location.href='change.php'</script>");
		exit(0);
	}
	$sex = $_POST['sex'];
	$age = $_POST['age'];
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" role="form" method = "POST">
        ...
        <button class="btn btn-lg btn-primary btn-block" name = "sumbit" value = "submit" type="submit">修改</button>
      </form>
