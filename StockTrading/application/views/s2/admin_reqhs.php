...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>资金账户管理子系统:管理员已处理请求</title>
		<style type="text/css">
			header#navbar-top{
				margin-top: 2%;
				display: block;
			...
			<div class="adrow row" style="background-color:#ffffff">
				...
				<div class="col-md-9" role="main" style="background-color:#ffffff">
					<div class="docs-section">
						<div class="page-header"><h2 id="main_title">已处理请求</h2></div>
						<table class="table table-bordered table-striped">
							<thead>
								<tr>
									<th style="width:100px">请求类型</th>
									<th style="width:170px">资金账户</th>
									<th style="width:140px">请求发送日期</th>
									<th style="width:140px">请求处理日期</th>
									<th style="width:120px">请求流水号</th>
								</tr>
								<tbody>
									<?php 
									if($ck==1)
